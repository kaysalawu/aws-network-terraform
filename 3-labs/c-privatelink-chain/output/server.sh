...
echo  "$(timeout 3 curl -4 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null spoke1pls.eu.c.cloudtuple.org) - spoke1pls.eu.c.cloudtuple.org"
echo  "$(timeout 3 curl -4 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null spoke2pls.eu.c.cloudtuple.org) - spoke2pls.eu.c.cloudtuple.org"
...
echo  "$(timeout 3 curl -6 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null spoke1pls.eu.c.cloudtuple.org) - spoke1pls.eu.c.cloudtuple.org"
echo  "$(timeout 3 curl -6 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null spoke2pls.eu.c.cloudtuple.org) - spoke2pls.eu.c.cloudtuple.org"
