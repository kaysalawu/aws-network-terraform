...
neighbor module.tgw2.router_bgp_ip0 remote-as module.tgw2.bgp_asn
neighbor module.tgw2.router_bgp_ip0 ebgp-multihop 255
neighbor module.tgw2.router_bgp_ip0 update-source lo
neighbor module.tgw2.router_bgp_ip1 remote-as module.tgw2.bgp_asn
neighbor module.tgw2.router_bgp_ip1 ebgp-multihop 255
neighbor module.tgw2.router_bgp_ip1 update-source lo
!
address-family ipv4 unicast
  network 10.22.0.0/24
  network 10.5.0.0/16
  neighbor module.tgw2.router_bgp_ip0 soft-reconfiguration inbound
  neighbor module.tgw2.router_bgp_ip1 soft-reconfiguration inbound
exit-address-family
!
line vty
!
