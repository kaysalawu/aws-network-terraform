...
conn tun1
    left=10.30.1.9
    leftid=18.119.149.140
    right=18.119.95.212
    rightid=18.119.95.212
    auto=start
    mark=100
...
10.30.1.9 18.119.95.212 : PSK "changeme"
10.30.1.9 52.15.222.166 : PSK "changeme"
...
case "$PLUTO_CONNECTION" in
  tun1)
    VTI_INTERFACE=tun1
    VTI_LOCALADDR=169.254.140.110
    VTI_REMOTEADDR=169.254.140.109
    ;;
  tun2)
    VTI_INTERFACE=tun2
    VTI_LOCALADDR=169.254.121.190
    VTI_REMOTEADDR=169.254.121.189
    ;;
esac
...
ip route 169.254.140.110/32 tun1
ip route 169.254.121.190/32 tun2
...
neighbor 169.254.140.109 remote-as 65022
neighbor 169.254.121.189 remote-as 65022
!
address-family ipv4 unicast
  network 10.30.0.0/24
  neighbor 169.254.140.109 soft-reconfiguration inbound
  neighbor 169.254.121.189 soft-reconfiguration inbound
exit-address-family
!
line vty
!
