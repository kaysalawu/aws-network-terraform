...
neighbor module.tgw1.router_bgp_ip0 remote-as module.tgw1.bgp_asn
neighbor module.tgw1.router_bgp_ip0 ebgp-multihop 255
neighbor module.tgw1.router_bgp_ip0 update-source lo
neighbor module.tgw1.router_bgp_ip1 remote-as module.tgw1.bgp_asn
neighbor module.tgw1.router_bgp_ip1 ebgp-multihop 255
neighbor module.tgw1.router_bgp_ip1 update-source lo
!
address-family ipv4 unicast
  network 10.11.0.0/24
  network 10.2.0.0/16
  neighbor module.tgw1.router_bgp_ip0 soft-reconfiguration inbound
  neighbor module.tgw1.router_bgp_ip1 soft-reconfiguration inbound
exit-address-family
!
line vty
!
