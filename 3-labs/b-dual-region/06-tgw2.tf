...
module "tgw2" {
  ...
  transit_gateway_routes = [
    { route_table_name = "vpc", name = "internet", attachment_name = module.hub2.vpc_name, ipv4_prefixes = ["0.0.0.0/0"] },
    { route_table_name = "hub", name = "spoke4", attachment_name = module.spoke4.vpc_name, ipv4_prefixes = local.spoke4_cidr },
    { route_table_name = "hub", name = "spoke5", attachment_name = module.spoke5.vpc_name, ipv4_prefixes = local.spoke5_cidr },
  ]
}
