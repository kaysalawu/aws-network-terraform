...
conn tun2
    left=10.10.2.9
    leftid=54.246.95.20
    right=34.249.104.245
    rightid=34.249.104.245
    auto=start
    mark=101
    leftupdown="/etc/ipsec.d/ipsec-vti.sh"
...
10.10.2.9 34.246.6.177 : PSK "changeme"
10.10.2.9 34.249.104.245 : PSK "changeme"
...
case "$PLUTO_CONNECTION" in
  tun1)
    VTI_INTERFACE=tun1
    VTI_LOCALADDR=169.254.15.142
    VTI_REMOTEADDR=169.254.15.141
    ;;
  tun2)
    VTI_INTERFACE=tun2
    VTI_LOCALADDR=169.254.11.134
    VTI_REMOTEADDR=169.254.11.133
    ;;
esac
...
ip route 169.254.15.142/32 tun1
ip route 169.254.11.134/32 tun2
...
neighbor 169.254.15.141 remote-as 65011
neighbor 169.254.11.133 remote-as 65011
!
address-family ipv4 unicast
  network 10.10.0.0/24
  neighbor 169.254.15.141 soft-reconfiguration inbound
  neighbor 169.254.11.133 soft-reconfiguration inbound
exit-address-family
!
line vty
!
