...
10.10.1.9 52.30.14.68 : PSK "changeme"
10.10.1.9 54.73.37.215 : PSK "changeme"
...
case "$PLUTO_CONNECTION" in
  tun1)
    VTI_INTERFACE=tun1
    VTI_LOCALADDR=169.254.95.50
    VTI_REMOTEADDR=169.254.95.49
    ;;
  tun2)
    VTI_INTERFACE=tun2
    VTI_LOCALADDR=169.254.134.118
    VTI_REMOTEADDR=169.254.134.117
    ;;
esac
...
ip route 169.254.95.50/32 tun1
ip route 169.254.134.118/32 tun2
...
neighbor 169.254.95.49 remote-as 65011
neighbor 169.254.134.117 remote-as 65011
!
address-family ipv4 unicast
  network 10.10.0.0/24
  neighbor 169.254.95.49 soft-reconfiguration inbound
  neighbor 169.254.134.117 soft-reconfiguration inbound
exit-address-family
!
line vty
!
